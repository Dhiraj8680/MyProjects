...
import com.dhiraj.myproject.todos.entity.User;
import com.dhiraj.myproject.todos.repository.TodoRepository;
import com.dhiraj.myproject.todos.request.TodoRequest;
import com.dhiraj.myproject.todos.response.TodoResponse;
import com.dhiraj.myproject.todos.util.FindAuthenticatedUser;
...
public class TodoServiceImpl implements  TodoService{
   ...
   private final FindAuthenticatedUser findAuthenticatedUser;
    ...
    public TodoResponse createTodo(TodoRequest todoRequest) {
        ...
        return  convertToTodoResponse(saveTodo);
