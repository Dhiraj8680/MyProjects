...
import com.dhiraj.myproject.todos.service.TodoService;
...
@Tag(name = "Todo REST API Endpoints", description = "Operation for managing todos")
@RestController
...
public class TodoController {
    ...
    @Operation(summary = "Get all  todo for user", description = "Fetch all  todo for the signed in user")
